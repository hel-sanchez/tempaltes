  ...
  <div className="flex flex-col min-h-screen">
    ...
    <header
      className={`fixed top-0 left-0 w-full py-2 transition-all duration-1000 ease-in-out z-50 ${
        scrolling ? "bg-[#e8e8e8] shadow-md" : "bg-cover bg-center bg-no-repeat"
      }`}
      style={{
        backgroundImage: scrolling
          ? "none" // no background image when shrunk
          : "url('https://images.pexels.com/photos/1029606/pexels-photo-1029606.jpeg')",
        height: headerHeight,
      }}
    >
      ...
      <div className="bg-transparent py-1 text-sm text-[#191919] hidden sm:block">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6">
          ...
          <div>
            <a
              href="#contact"
              className="text-[#e6a310] hover:text-[#203a53]"
            >
              Contact Us
            </a>
          </div>
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 relative">
        ...
        <div className="mb-5">
          <a href="/">
            <img
              src={scrolling ? "/simpleProjex.png" : "/simpleProjex.png"}
          ...
          <button
            ...
            className="lg:hidden text-(#203a53) mb-6 bg-white opacity-50 p-1/2 rounded-md"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
        ...
        {!scrolling && (
          <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 text-center">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight mb-8 animate-fade-in relative">
              <span className="block text-lg sm:text-xl md:text-2xl text-[#191919] mb-5">
                Proposals Made Easy
              </span>
            ...
            <div className="space-x-8 animate-fade-in animate-delay-600">
              <button className="bg-[#203a53] text-white px-10 py-5 rounded-xl text-lg font-semibold hover:text-black hover:bg-[#e6a310] hover:text-[#191919] transition duration-300 transform hover:scale-105">
                Schedule a Demo
              </button>
            </div>
          </div>
