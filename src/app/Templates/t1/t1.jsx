      ...
      <header
        ...
        style={{
          backgroundImage: scrolling
            ...
            : "url('https://images.pexels.com/photos/1437493/pexels-photo-1437493.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')",
          height: headerHeight,
        }}
      >
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 relative">
          ...
          <div className="mb-5">
            <a href="/">
              <img
                src={scrolling ? "/sideways.png" : "/sideways.png"}
