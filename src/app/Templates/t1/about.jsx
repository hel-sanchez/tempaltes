      ...
      <div className="container mx-auto max-w-8xl mt-5">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="flex flex-col items-center text-center gap-4 p-4 border border-[#4682b4] rounded-lg shadow-lg bg-white text-[#333333] hover:bg-[#f1f1f1] hover:scale-105 transition-all duration-300 ease-in-out"
                >
                  <span className="text-[#4682b4] text-3xl">{item.icon}</span>
          ...
          {stats.map((item, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-center mb-6">
                <div className="w-28 h-28 rounded-full border-4 border-[#4682b4] flex items-center justify-center">
                  <span
                    ref={ref}
                    className="text-[#4682b4] text-4xl font-bold drop-shadow-lg"
                  >
                    {isInView && (
              ...
              <div className="flex flex-col items-center">
                <span className="text-3xl text-[#ffa500] mb-2">
                  {item.icon}
                </span>
                <h4 className="text-lg font-semibold text-[#4682b4]">
                  {item.text}
                </h4>
              </div>
            </motion.div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-16 mb-16 bg-[#4682b4] py-12 px-8 rounded-lg shadow-lg relative">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="flex flex-col items-center text-center p-6 border border-white rounded-lg shadow-lg bg-white text-[#333333] hover:bg-[#f1f1f1] hover:scale-105 transition-all duration-300 ease-in-out relative"
                >
                  <span className="text-[#4682b4] text-3xl mb-4">
                    {item.icon}
                  </span>
                  <span className="text-sm md:text-base">{item.text}</span>
                </div>
          ...
          <div className="absolute inset-0 flex justify-between items-start">
            <div className="w-4 h-4 bg-[#333333] rounded-full shadow-lg"></div>
            <div className="w-4 h-4 bg-[#333333] rounded-full shadow-lg"></div>
          </div>
