    ...
    <div id="proposalStress" className="bg-[#ffffff] py-20 px-6">
      ...
      >
        <p className="text-[#333333] text-base leading-relaxed">
          ...
          mere minutes. That means less time managing paperwork, and more time
      ...
      >
        <button className="px-8 py-4 bg-[#4682b4] text-[#ffffff] font-semibold text-lg rounded-lg shadow-md hover:bg-[#333333] hover:shadow-lg transform hover:scale-105 transition-all duration-300">
          Schedule a Demo
        </button>
      </div>
    </div>
