...
const About = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-blue-50 to-white min-h-screen p-8">
      ...
      >
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left opacity-0 translate-x-12 animate-slide-left">
            ...
            <p className="text-lg md:text-xl text-gray-800 max-w-xl mx-auto mb-8">
      ...
      <hr className="border-t-2 border-blue-500 my-4 mb-10" />

      {/* About Us Section */}
      <div className="max-w-6xl mx-auto text-center mb-12 px-4 mt-16">
        <h1 className="text-5xl font-extrabold text-blue-600 mb-4 hover:scale-105">
          <div
      ...
      <div className="grid md:grid-cols-2 gap-12 px-4">
        {/* Mission Section */}
        <div
          className={`bg-white p-8 rounded-lg shadow-xl transform transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-2xl ${
            isVisible ? "animate-slide-right" : "opacity-0"
          }`}
        >
