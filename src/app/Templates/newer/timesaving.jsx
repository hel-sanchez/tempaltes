...
const TimeSaving = ({ darkMode }) => {
  return (
    <section className={`relative py-16 px-5 font-sans ${darkMode ? "bg-[#191919]" : "bg-white"}`}>
      {/* Main Section */}
      <div className="text-center md:ml-12 mb-5 mt-10">
        <motion.h1
          className={`text-6xl font-bold ${darkMode ? "text-[#e6a310]" : "text-[#e6a310]"} mb-4 tracking-wide`}
        ...
        <motion.p
          className={`text-2xl ${darkMode ? "text-white" : "text-[#203a53]"} tracking-widest`}
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 tracking-widest">
        ...
        >
          ...
          />
          <div className={`absolute inset-0 ${darkMode ? "bg-black bg-opacity-60" : "bg-black bg-opacity-40"} flex items-top justify-top`}>
        ...
        >
          <img
            ...
            className="w-full h-full object-cover"
          />
          <div className={`absolute inset-0 ${darkMode ? "bg-black bg-opacity-60" : "bg-black bg-opacity-30"} flex items-top justify-top`}>
            <h2 className="text-xl font-bold text-white px-4 mt-5">
